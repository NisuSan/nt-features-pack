...
`
export const injectColorsToTailwind = () => {
...
export const createTypeForAppColors = () => {
  const colors = require(resolve(useNuxt().options.buildDir, 'autogenerated/client/theme/theme.colors.ts'))
...
export const generateColorChosers = () => {
...
export const naiveUiOverrides = (appColors: AppColors, themeName: ComputedRef<string>) => {

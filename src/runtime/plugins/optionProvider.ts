    ...
    export default defineNuxtPlugin((nuxtApp) => ({ provide: { ntFeaturePack: { themeGenerator: { themeCode: (appColors: Record<string, string>, themeName: ComputedRef<string>) => { const ld = useColorChosers(themeName)
